...
def test_get_circles_missing_params():
    ...
    app = _api_client()
    test_urls = [
        "/circles_2D/?num_points=5&center_x=2.3&center_y=3.44",
        "/circles_2D/?num_points=5&center_x=2.3&radius=10",
        "/circles_2D/?num_points=5&center_y=-3.44&radius=10"
    ]
...
def test_get_circles_missing_count():
    ...
    app = _api_client()
    test_urls = [
        "/circles_2D/?center_x=2.3&center_y=-3.44&radius=10"
    ]
    def _check_response(response):
        assert response.status_code == 400
        assert response.content_type == "application/json"
...
def test_get_circles_invalid_params():
    ...
    app = _api_client()
    test_urls = [
        "/circles_2D/?num_points=5&center_x=text&center_y=-3.44&radius=10",
        "/circles_2D/?num_points=5&center_x=2.3&center_y=text&radius=10",
        "/circles_2D/?num_points=5&center_x=2.3&center_y=-3.44&radius=text",
        "/circles_2D/?num_points=5&center_x=2.3&center_y=-3.44&radius=0",
        "/circles_2D/?num_points=5&center_x=2.3&center_y=-3.44&radius=-1.5"
    ]
    def _check_response(response):
        assert response.status_code == 400
        assert response.content_type == "application/json"
...
def test_get_circles_invalid_count():
    ...
    app = _api_client()
    test_urls = [
        "/circles_2D/?num_points=0&center_x=2.3&center_y=-3.44&radius=10",
        "/circles_2D/?num_points=-3&center_x=2.3&center_y=-3.44&radius=10",
        "/circles_2D/?num_points=2.5&center_x=2.3&center_y=-3.44&radius=10",
        "/circles_2D/?num_points=text&center_x=2.3&center_y=-3.44&radius=10"
    ]
    def _check_response(response):
        assert response.status_code == 400
        assert response.content_type == "application/json"
